...
public class CommandTestUtil {
    ...
    public static final String VALID_ROLE_AMY = "HA";
    public static final String VALID_ROLE_BOB = "FH";
    ...
    public static void showResidentAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredResidentsList(new NameContainsKeywordsPredicate(Arrays.asList(splitName[0])));
