...
public class TypicalResidents {
    ...
    public static final Resident ALICE = new ResidentBuilder().withName("Alice Pauline")
            .withUnitNumber("123, Jurong West Ave 6, #08-111").withPhone("94351253").withRole("NONE").build();
