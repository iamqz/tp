...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_UNITNUMBER, PREFIX_PHONE)
        ...
        UnitNumber unitNumber = ParserUtil.parseAddress(argMultimap.getValue(PREFIX_UNITNUMBER).get());

        Resident resident = new Resident(name, phone, unitNumber);
